...
struct c_backend_device *c_backend_device_open(struct c_backend *backend,
                                               const char *path,
                                               enum C_BACKEND_DEV_TYPES type);
void c_backend_device_close(struct c_backend *backend,
                            struct c_backend_device *device);
#endif
