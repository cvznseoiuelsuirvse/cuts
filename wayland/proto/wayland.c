...
C_WL_INTERFACE_REGISTER(wl_display_interface, "wl_display", 1, 2, -1, 
...
void wl_display_add_listener(struct c_wl_display *display, struct c_wl_display_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_display", listeners, sizeof(*listeners), userdata);
}
...
C_WL_INTERFACE_REGISTER(wl_registry_interface, "wl_registry", 1, 1, -1, 
...
void wl_registry_add_listener(struct c_wl_display *display, struct c_wl_registry_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_registry", listeners, sizeof(*listeners), userdata);
}
...
C_WL_INTERFACE_REGISTER(wl_compositor_interface, "wl_compositor", 6, 2, -1, 
...
void wl_compositor_add_listener(struct c_wl_display *display, struct c_wl_compositor_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_compositor", listeners, sizeof(*listeners), userdata);
}

C_WL_INTERFACE_REGISTER(wl_shm_pool_interface, "wl_shm_pool", 2, 3, 1, 
...
void wl_shm_pool_add_listener(struct c_wl_display *display, struct c_wl_shm_pool_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_shm_pool", listeners, sizeof(*listeners), userdata);
}
...
C_WL_INTERFACE_REGISTER(wl_shm_interface, "wl_shm", 2, 2, 1, 
...
void wl_shm_add_listener(struct c_wl_display *display, struct c_wl_shm_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_shm", listeners, sizeof(*listeners), userdata);
}
...
C_WL_INTERFACE_REGISTER(wl_buffer_interface, "wl_buffer", 1, 1, 0, 
...
void wl_buffer_add_listener(struct c_wl_display *display, struct c_wl_buffer_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_buffer", listeners, sizeof(*listeners), userdata);
}
...
C_WL_INTERFACE_REGISTER(wl_data_offer_interface, "wl_data_offer", 3, 5, 2, 
...
void wl_data_offer_add_listener(struct c_wl_display *display, struct c_wl_data_offer_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_data_offer", listeners, sizeof(*listeners), userdata);
}
...
C_WL_INTERFACE_REGISTER(wl_data_source_interface, "wl_data_source", 3, 3, 1, 
...
void wl_data_source_add_listener(struct c_wl_display *display, struct c_wl_data_source_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_data_source", listeners, sizeof(*listeners), userdata);
}
...
C_WL_INTERFACE_REGISTER(wl_data_device_interface, "wl_data_device", 3, 3, 2, 
...
void wl_data_device_add_listener(struct c_wl_display *display, struct c_wl_data_device_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_data_device", listeners, sizeof(*listeners), userdata);
}

C_WL_INTERFACE_REGISTER(wl_data_device_manager_interface, "wl_data_device_manager", 3, 2, -1, 
...
void wl_data_device_manager_add_listener(struct c_wl_display *display, struct c_wl_data_device_manager_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_data_device_manager", listeners, sizeof(*listeners), userdata);
}

C_WL_INTERFACE_REGISTER(wl_shell_interface, "wl_shell", 1, 1, -1, 
...
void wl_shell_add_listener(struct c_wl_display *display, struct c_wl_shell_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_shell", listeners, sizeof(*listeners), userdata);
}
...
C_WL_INTERFACE_REGISTER(wl_shell_surface_interface, "wl_shell_surface", 1, 10, -1, 
...
void wl_shell_surface_add_listener(struct c_wl_display *display, struct c_wl_shell_surface_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_shell_surface", listeners, sizeof(*listeners), userdata);
}
...
C_WL_INTERFACE_REGISTER(wl_surface_interface, "wl_surface", 6, 11, 0, 
...
void wl_surface_add_listener(struct c_wl_display *display, struct c_wl_surface_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_surface", listeners, sizeof(*listeners), userdata);
}
...
C_WL_INTERFACE_REGISTER(wl_seat_interface, "wl_seat", 10, 4, 3, 
...
void wl_seat_add_listener(struct c_wl_display *display, struct c_wl_seat_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_seat", listeners, sizeof(*listeners), userdata);
}
...
C_WL_INTERFACE_REGISTER(wl_pointer_interface, "wl_pointer", 10, 2, 1, 
...
void wl_pointer_add_listener(struct c_wl_display *display, struct c_wl_pointer_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_pointer", listeners, sizeof(*listeners), userdata);
}
...
C_WL_INTERFACE_REGISTER(wl_keyboard_interface, "wl_keyboard", 10, 1, 0, 
...
void wl_keyboard_add_listener(struct c_wl_display *display, struct c_wl_keyboard_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_keyboard", listeners, sizeof(*listeners), userdata);
}
...
C_WL_INTERFACE_REGISTER(wl_touch_interface, "wl_touch", 10, 1, 0, 
...
void wl_touch_add_listener(struct c_wl_display *display, struct c_wl_touch_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_touch", listeners, sizeof(*listeners), userdata);
}
...
C_WL_INTERFACE_REGISTER(wl_output_interface, "wl_output", 4, 1, 0, 
...
void wl_output_add_listener(struct c_wl_display *display, struct c_wl_output_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_output", listeners, sizeof(*listeners), userdata);
}

C_WL_INTERFACE_REGISTER(wl_region_interface, "wl_region", 1, 3, 0, 
...
void wl_region_add_listener(struct c_wl_display *display, struct c_wl_region_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_region", listeners, sizeof(*listeners), userdata);
}

C_WL_INTERFACE_REGISTER(wl_subcompositor_interface, "wl_subcompositor", 1, 2, 0, 
...
void wl_subcompositor_add_listener(struct c_wl_display *display, struct c_wl_subcompositor_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_subcompositor", listeners, sizeof(*listeners), userdata);
}

C_WL_INTERFACE_REGISTER(wl_subsurface_interface, "wl_subsurface", 1, 6, 0, 
...
void wl_subsurface_add_listener(struct c_wl_display *display, struct c_wl_subsurface_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_subsurface", listeners, sizeof(*listeners), userdata);
}

C_WL_INTERFACE_REGISTER(wl_fixes_interface, "wl_fixes", 1, 2, 0, 
...
void wl_fixes_add_listener(struct c_wl_display *display, struct c_wl_fixes_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "wl_fixes", listeners, sizeof(*listeners), userdata);
}
