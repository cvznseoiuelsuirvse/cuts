...
C_WL_INTERFACE_REGISTER(zxdg_decoration_manager_v1_interface, "zxdg_decoration_manager_v1", 2, 2, 0, 
...
void zxdg_decoration_manager_v1_add_listener(struct c_wl_display *display, struct c_zxdg_decoration_manager_v1_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "zxdg_decoration_manager_v1", listeners, sizeof(*listeners), userdata);
}
...
C_WL_INTERFACE_REGISTER(zxdg_toplevel_decoration_v1_interface, "zxdg_toplevel_decoration_v1", 2, 3, 0, 
...
void zxdg_toplevel_decoration_v1_add_listener(struct c_wl_display *display, struct c_zxdg_toplevel_decoration_v1_listeners *listeners, void *userdata) {
  c_wl_display_add_listener(display, "zxdg_toplevel_decoration_v1", listeners, sizeof(*listeners), userdata);
}
