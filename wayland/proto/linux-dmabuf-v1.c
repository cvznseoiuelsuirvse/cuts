...
C_WL_EVENT zwp_linux_dmabuf_v1_modifier(struct c_wl_connection *conn, c_wl_object_id zwp_linux_dmabuf_v1, c_wl_uint format, c_wl_uint modifier_hi, c_wl_uint modifier_lo) {
  ...
  return c_wl_connection_post(conn, &msg, 3, format, modifier_hi, modifier_lo);
}
...
void zwp_linux_dmabuf_v1_add_listener(struct c_wl_display *display, struct c_zwp_linux_dmabuf_v1_listeners *listeners, void *userdata) {
  c_wl_display_add_interface_listener(display, "zwp_linux_dmabuf_v1", listeners, userdata);
}
...
C_WL_EVENT zwp_linux_buffer_params_v1_created(struct c_wl_connection *conn, c_wl_object_id zwp_linux_buffer_params_v1, c_wl_new_id wl_buffer) {
  ...
  return c_wl_connection_post(conn, &msg, 1, wl_buffer);
}
...
void zwp_linux_buffer_params_v1_add_listener(struct c_wl_display *display, struct c_zwp_linux_buffer_params_v1_listeners *listeners, void *userdata) {
  c_wl_display_add_interface_listener(display, "zwp_linux_buffer_params_v1", listeners, userdata);
}
...
C_WL_EVENT zwp_linux_dmabuf_feedback_v1_format_table(struct c_wl_connection *conn, c_wl_object_id zwp_linux_dmabuf_feedback_v1, c_wl_fd fd, c_wl_uint size) {
  ...
  return c_wl_connection_post(conn, &msg, 2, fd, size);
}
C_WL_EVENT zwp_linux_dmabuf_feedback_v1_main_device(struct c_wl_connection *conn, c_wl_object_id zwp_linux_dmabuf_feedback_v1, c_wl_array *device) {
  ...
  return c_wl_connection_post(conn, &msg, 1, device);
}
...
C_WL_EVENT zwp_linux_dmabuf_feedback_v1_tranche_formats(struct c_wl_connection *conn, c_wl_object_id zwp_linux_dmabuf_feedback_v1, c_wl_array *indices) {
  ...
  return c_wl_connection_post(conn, &msg, 1, indices);
}
C_WL_EVENT zwp_linux_dmabuf_feedback_v1_tranche_flags(struct c_wl_connection *conn, c_wl_object_id zwp_linux_dmabuf_feedback_v1, enum zwp_linux_dmabuf_feedback_v1_tranche_flags_enum flags) {
  ...
  return c_wl_connection_post(conn, &msg, 1, flags);
}
...
void zwp_linux_dmabuf_feedback_v1_add_listener(struct c_wl_display *display, struct c_zwp_linux_dmabuf_feedback_v1_listeners *listeners, void *userdata) {
  c_wl_display_add_interface_listener(display, "zwp_linux_dmabuf_feedback_v1", listeners, userdata);
}
